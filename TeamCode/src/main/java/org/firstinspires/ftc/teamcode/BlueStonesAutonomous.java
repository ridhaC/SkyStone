...
@Autonomous(name="Blue Stones",group="Linear Opmode")
public class BlueStonesAutonomous extends LinearOpMode {
    private RobotHardware robot = new RobotHardware();
    private ElapsedTime elapsedTime = new ElapsedTime();

    public BlueStonesAutonomous() {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("ss position",robot.getSkystonePosition());
